                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-9 col-lg-8 col">
                                <div class="row">
                                    <div
                                        class="col align-content-lg-center align-content-center align-content-md-center align-content-xl-center align-content-sm-center">
                                    ...
                                    <div class="swiper-container">
                                        <div class="swiper-wrapper">
                                            @foreach($pic as $key=>$value)
                                                <div class="swiper-slide"><img src="{{ url("/uploads/".$value) }}"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <img src="{{ url("/uploads/".$al->path) }}"  class="rounded-sm " height="210" width="420"><br>
                                    <p><span class="c-icon cil-description"></span>&nbsp;{{ $al->title }}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
                                    ...
                                    <div class="col-6 ">
                                        <ul class="card">
                                            @foreach($comments as  $Com)
                                                @if($Com->parents==0)
                                                    <li class="p-3"><b>{{ $Com->fullname }}:</b> {{ $Com->context }}
                                                        <ul>
                                                            @foreach($comments as $reply)
                                                                @if($Com->id == $reply->parents)
                                                                    <li class="card"><b>{{ $reply->fullname }}
                                                                            :</b> {{ $reply->context }}</li>
                                                                @endif
                                                            @endforeach
                                                        </ul>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input class="form-control" type="text" id="fullname"
                                                                   placeholder="نام و نام خانوادگی" name="fullname"
                                                                   value="" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <textarea class="form-control" type="text" id="context"
                                                                      placeholder="متن نظر" name="context"
                                                                      required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="row">
