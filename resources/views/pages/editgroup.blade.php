                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="{{ route("category.update",$categories) }}" method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group mb-2">
                                              ...
                                              <span class="c-icon cil-notes"></span>
                                                ...
                                                <input class="form-control" type="text" id="group_name" placeholder="نام گروه" name="group_name" value="{{ $categories->name }}" required autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">&nbsp;</div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group mb-2">
                                              ...
                                              <span class="c-icon cil-list-numbered"></span>
                                                ...
                                                <input class="form-control" type="number" id="ordered" placeholder="شماره ردیف" name="ordered" min="1" value="{{ $categories->ordered }}" required autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="clearfix">&nbsp;</div>
                                    <div class="row">
                                        <div class="col-12">
                                            <input type="submit" name="submit" class="btn btn-success" value="ویرایش">
                                        </div>
                                    </div>
                                </form>
                            </div>
